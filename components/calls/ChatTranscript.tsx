...
export function ChatTranscript({ messages, audioUrl }: ChatTranscriptProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
            {/* Audio Player Header */}
            {audioUrl && (
                <div className="bg-white dark:bg-gray-800 p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between shadow-sm z-10">
                    <div className="flex items-center gap-3">
                        <Button
                            variant="default"
                            size="icon"
                            className="rounded-full h-10 w-10 bg-blue-600 hover:bg-blue-700 text-white shadow-md"
                            onClick={togglePlay}
                        >
