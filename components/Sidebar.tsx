                    ...
                    {navItems.map((item, index) => {
                        ...
                        return (
                            <Link
                                ...
                                href={item.href}
                                className={cn(
                                    "flex items-center gap-3 rounded-md px-3 py-2 transition-all duration-200 ease-in-out hover:text-gray-900",
                                    isActive ? "bg-gray-100 text-gray-900 translate-x-1" : "hover:bg-gray-100/50 hover:translate-x-1"
                                )}
                            >
