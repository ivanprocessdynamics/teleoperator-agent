...
export function TestingEnvironment({ subworkspaceId, orbOnly }: TestingEnvironmentProps) {
    ...
    const RightColumn = (
        <div className="h-full">
            <div className={`rounded-xl border border-gray-200 dark:border-blue-500/30 bg-white dark:bg-blue-500/10 p-8 h-full flex flex-col justify-center items-center relative overflow-hidden ${orbOnly ? 'border-none bg-transparent shadow-none' : ''}`}>
